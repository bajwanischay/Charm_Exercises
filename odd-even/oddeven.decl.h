...
class CkIndex_Chr:public CkIndex_ArrayElement{
  public:
    ...
    static int reg_send_void();
    // Entry point index lookup
    
    inline static int idx_send_void() {
      static int epidx = reg_send_void();
      return epidx;
    }

    
    inline static int idx_send(void (Chr::*)() ) {
      return idx_send_void();
    }


    
    static int send() { return idx_send_void(); }
    
    static void _call_send_void(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_send_void(void* impl_msg, void* impl_obj);
    ...
    /* DECLS: void sendNumber(int num, int step);
     */
    // Entry point registration at startup
    
    static int reg_sendNumber_marshall4();
    // Entry point index lookup
    
    inline static int idx_sendNumber_marshall4() {
      static int epidx = reg_sendNumber_marshall4();
      return epidx;
    }

    
    inline static int idx_sendNumber(void (Chr::*)(int num, int step) ) {
      return idx_sendNumber_marshall4();
    }


    
    static int sendNumber(int num, int step) { return idx_sendNumber_marshall4(); }
    
    static void _call_sendNumber_marshall4(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_sendNumber_marshall4(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_sendNumber_marshall4(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_sendNumber_marshall4(PUP::er &p,void *msg);
 ...
 */
    ...
    void send(const CkEntryOptions *impl_e_opts=NULL) ;
 ...
 */
    ...
    void sendNumber(int num, int step, const CkEntryOptions *impl_e_opts=NULL) ;
...
class Closure_Chr {
  public:
    ...
    struct send_2_closure;


    struct finalsend_3_closure;


    struct sendNumber_4_closure;
